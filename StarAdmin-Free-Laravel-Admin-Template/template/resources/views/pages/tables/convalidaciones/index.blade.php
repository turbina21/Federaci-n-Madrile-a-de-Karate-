    ...
    <div class="card">
      <div class="card-body">
        <div class="pull-left" style="text-align: center;">
          <h4 class="card-title">CONVALIDACIONES</h4>
        </div>
        <div class="pull-right" style="text-align: right;">
          <a class="btn btn-success" href="{{ route('convalidaciones.create') }}"> AÑADIR CONVALIDACIONES</a>
        </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th>ACREDITACIÓN</th>
                <th>COPIA DE TÍTULOS</th>
                <th>PLANE DE ESTUDIO</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                $aux1='';
                $label1='';
                if($convalidacion->CONCURRICULUMVISADO==1){
                $aux1='badge-success';
                $label1='SÍ';
                }else{
                $aux1='badge-danger';
                ...
                $aux2='';
                $label2='';
                if($convalidacion->CONACREDITACION==1){
                $aux2='badge-success';
                $label2='SÍ';
                }else{
                $aux2='badge-danger';
                ...
                $aux3='';
                $label3='';
                if($convalidacion->CONCOPIATITULOS==1){
                $aux3='badge-success';
                $label3='SÍ';
                }else{
                $aux3='badge-danger';
                ...
                $aux4='';
                $label4='';
                if($convalidacion->CONPLANESTUDIO==1){
                $aux4='badge-success';
                $label4='SÍ';
                }else{
                $aux4='badge-danger';
