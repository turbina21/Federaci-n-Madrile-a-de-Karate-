...
<div class="content-wrapper d-flex align-items-center justify-content-center auth theme-one" style="background-image: url({{ url('assets/images/auth/loginKarate.jpg') }}); background-size: cover;">
  <div class="row w-100">
